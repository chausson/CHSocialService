...
- (IBAction)qqShare:(UIButton *)sender {
    [[CHSocialServiceCenter shareInstance] shareTitle:@"分享" content:@"单个测试分享" imageURL:@"http://p2pguide.sudaotech.com/platform/image/1/20160318/3c896c87-65b6-481d-81ca-1b4a0b6d8dd4/" image:nil urlResource:@"http://www.alibaba.com" type:CHSocialWeChatTimeLine controller:self completion:nil];
}
